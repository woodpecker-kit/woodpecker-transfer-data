...
ROOT_NAME?=woodpecker-transfer-data
...
ENV_GO_GODOC_EXPORT_PKG =github.com/woodpecker-kit/woodpecker-transfer-data/
...
## build args start
ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-transfer-data/main.go
ENV_ROOT_BUILD_PATH=build
