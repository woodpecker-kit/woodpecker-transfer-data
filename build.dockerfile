# This dockerfile uses extends image https://hub.docker.com/woodpecker-kit/woodpecker-transfer-data
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/woodpecker-kit/woodpecker-transfer-data
ARG GO_ENV_ROOT_BUILD_BIN_NAME=woodpecker-transfer-data
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-transfer-data/main.go
...
ENTRYPOINT [ "/app/woodpecker-transfer-data" ]
# CMD ["/app/woodpecker-transfer-data", "--help"]